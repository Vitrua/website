...
print(missing_keys)
              `})})}),e.jsx(t.p,{variants:n,style:{marginBottom:"10px",display:"flex",justifyContent:"center"},children:e.jsx("a",{href:"https://patreon.com/Vitrua",children:e.jsx("img",{src:"/supportmon.png",alt:"Support",width:"200",style:{marginTop:"10px"}})})})]})})},y={open:{transition:{staggerChildren:.1}},closed:{transition:{staggerChildren:.05,staggerDirection:-1}}},l={open:{y:0,opacity:1},closed:{y:50,opacity:0}},f=()=>{const i="https://vitrua.top";return e.jsxs(t.div,{className:"links",variants:y,children:[e.jsx(t.a,{href:`${i}/#Home`,variants:l,whileHover:{scale:1.1},whileTap:{scale:.95},children:"Home"}),e.jsx(t.a,{href:`${i}/chobe/`,variants:l,whileHover:{scale:1.1},whileTap:{scale:.95},children:"Chobe"}),e.jsx(t.a,{href:`${i}/autoversion/`,variants:l,whileHover:{scale:1.1},whileTap:{scale:.95},children:"Autoversion"}),e.jsx(t.a,{href:`${i}/helmunused/`,variants:l,whileHover:{scale:1.1},whileTap:{scale:.95},children:"Helm unused"})]})};const v=({setOpen:i})=>e.jsx("button",{onClick:()=>i(s=>!s),children:e.jsxs("svg",{width:"23",height:"23",viewBox:"0 0 23 23",children:[e.jsx(t.path,{strokeWidth:"3",stroke:"black",strokeLinecap:"round",variants:{closed:{d:"M 2 2.5 L 20 2.5"},open:{d:"M 3 16.5 L 17 2.5"}}}),e.jsx(t.path,{strokeWidth:"3",stroke:"black",strokeLinecap:"round",d:"M 2 9.423 L 20 9.423",variants:{closed:{opacity:1},open:{opacity:0}}}),e.jsx(t.path,{strokeWidth:"3",stroke:"black",strokeLinecap:"round",variants:{closed:{d:"M 2 16.346 L 20 16.346"},open:{d:"M 3 2.5 L 17 16.346"}}})]})}),j={open:{clipPath:"circle(1200px at 50px 50px)",transition:{type:"spring",stiffness:20}},closed:{clipPath:"circle(30px at 50px 50px)",transition:{delay:.5,type:"spring",stiffness:400,damping:40}}},g=()=>{const[i,s]=o.useState(!1),r=o.useRef(null);return o.useEffect(()=>{const a=c=>{r.current&&!r.current.contains(c.target)&&s(!1)};return document.addEventListener("mousedown",a),()=>{document.removeEventListener("mousedown",a)}},[]),e.jsxs(t.div,{className:"sidebar",ref:r,animate:i?"open":"closed",children:[e.jsx(t.div,{className:"bg",variants:j,children:e.jsx(f,{})}),e.jsx(v,{setOpen:s})]})};const _=()=>e.jsxs("div",{className:"navbar",children:[e.jsx(g,{}),e.jsxs("div",{className:"wrapper",children:[e.jsx(t.span,{initial:{opacity:0,scale:.5},animate:{opacity:1,scale:1},transition:{duration:.5},children:"Welcome to vitrua.top only official website"}),e.jsxs("div",{className:"social",children:[e.jsx("a",{href:"https://patreon.com/Vitrua",children:e.jsx("img",{src:"/patreon.png",alt:""})}),e.jsx("a",{href:"https://instagram.com/vitruastudio",children:e.jsx("img",{src:"/instagram.png",alt:""})})]})]})]}),k=()=>e.jsxs("div",{children:[e.jsx(p,{}),e.jsxs("section",{id:"Helmunused Tool",children:[e.jsx(_,{}),e.jsx(x,{})]})]});d.createRoot(document.getElementById("root")).render(e.jsx(h.StrictMode,{children:e.jsx(k,{})}));
